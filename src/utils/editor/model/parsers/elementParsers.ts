...
/**
 * Creates a paragraph node from an HTML element
 */
export function createParagraphFromElement(element: HTMLElement, blockId: string): DT.Node {
...
/**
 * Creates a heading node from an HTML element
 */
export function createHeadingFromElement(element: HTMLElement, blockId: string): DT.HeadingNode {
...
/**
 * Creates a list node from an HTML element
 */
export function createListFromElement(element: HTMLElement, type: 'bullet_list' | 'ordered_list', blockId: string): DT.ListNode {
...
/**
 * Creates a list item node from an HTML element
 */
export function createListItemFromElement(element: HTMLElement): DT.ListItemNode {
...
/**
 * Creates a table node from an HTML element
 */
export function createTableFromElement(element: HTMLElement, blockId: string): DT.TableNode {
...
/**
 * Creates an image node from an HTML element
 */
export function createImageFromElement(element: HTMLImageElement, blockId: string): DT.ImageNode {
...
/**
 * Creates a blockquote node from an HTML element
 */
export function createBlockquoteFromElement(element: HTMLElement, blockId: string): DT.BlockquoteNode {
  const content: DT.Node[] = [];
...
/**
 * Creates a code block node from an HTML element
 */
export function createCodeBlockFromElement(element: HTMLElement, blockId: string): DT.CodeBlockNode {
...
/**
 * Creates a node from a div element
 */
export function createNodeFromDiv(element: HTMLElement, blockId: string): DT.Node {
...
/**
 * Creates inline content from an HTML element
 */
export function createInlineContent(element: HTMLElement): DT.TextNode | DT.Node | null {
...
/**
 * Processes children of an HTML element into document nodes
 */
export function processElementChildren(element: HTMLElement): (DT.Node | DT.TextNode)[] {
...
/**
 * Processes a DOM node into a document node
 */
export function processNode(node: Node): DT.Node | DT.TextNode | null {
  ...
  switch (element.tagName.toLowerCase()) {
    ...
    case 'img':
      // Handle image elements safely
      if (element instanceof HTMLImageElement) {
        return createImageFromElement(element, blockId);
      }
      // Fallback for elements that look like images but aren't
      const imgFallback = {
        src: element.getAttribute('src') || '',
        alt: element.getAttribute('alt') || '',
        title: element.getAttribute('title') || '',
        width: element.getAttribute('width') ? parseInt(element.getAttribute('width') || '0') : 0,
        height: element.getAttribute('height') ? parseInt(element.getAttribute('height') || '0') : 0
      } as HTMLImageElement;
      return createImageFromElement(imgFallback, blockId);
    case 'blockquote':
